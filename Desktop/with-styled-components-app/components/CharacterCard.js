    ...
    <>
      ...
      <CardContainer>
        ...
        <CharacterInfo>
          ...
          <h4>
            {(character?.bornLocation && "EMPLACEMENTS") || (character?.diedLocation && "EMPLACEMENTS") || (character?.homeworld && "EMPLACEMENTS")}
          </h4>
          ...
          <h4>Dimensions</h4>
          <span>Hauteur: {character?.dimensions}m</span>
          <h4>Espèce</h4>
          <span>{character?.species}</span>
          <h4>Wiki</h4>
          <a href={character?.wiki} target="_blank" rel="noreferrer">Lire plus {character?.name}</a>
        </CharacterInfo>
      </CardContainer>
    </>
